...
class RenderWindow(Qt.QMainWindow):
    ...
    def __init__(self, ct_file, stl_file, parent=None, ):
        ...
        #Keyboard
        self.main_ren.AddActor(self.txtActor(2, 84, 20, 'Press "l" to turn on/off the LIVER'))
        self.main_ren.AddActor(self.txtActor(2, 64, 20, 'Press "s" to turn on/off the SKELETON'))
        self.main_ren.AddActor(self.txtActor(2, 44, 20, 'Press "t" to turn on/off the TUMOR'))
        self.main_ren.AddActor(self.txtActor(2, 24, 20, 'Press "w" to turn on/off the WIREFRAME for liver'))
        self.main_ren.AddActor(self.txtActor(2, 4, 20, 'Press "Alt + F4" for EXIT'))
